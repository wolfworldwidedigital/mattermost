    ...
    it('should match help text', () => {
        const helpText = {
            ...
            sessionLengthWebInHours: {
                ...
                true: 'Set the number of hours from the last activity in Cusmato to the expiry of the user’s session when using email and AD/LDAP authentication. After changing this setting, the new session length will take effect after the next time the user enters their credentials.',
            },
            sessionLengthMobileInHours: {
                false: 'The number of hours from the last time a user entered their credentials to the expiry of the user\'s session. After changing this setting, the new session length will take effect after the next time the user enters their credentials.',
                true: 'Set the number of hours from the last activity in Cusmato to the expiry of the user’s session on mobile. After changing this setting, the new session length will take effect after the next time the user enters their credentials.',
            },
            sessionLengthSSOInHours: {
                ...
                true: 'Set the number of hours from the last activity in Cusmato to the expiry of the user’s session for SSO authentication, such as SAML, GitLab and OAuth 2.0. If the authentication method is SAML or GitLab, the user may automatically be logged back in to Cusmato if they are already logged in to SAML or GitLab. After changing this setting, the setting will take effect after the next time the user enters their credentials.',
            },
