...
const enterprisePaidFeatures = [
    ...
    {sidebarName: 'Data Retention Policy', featureDiscoveryTitle: 'Create data retention schedules with Cusmato Enterprise'},
    {sidebarName: 'Compliance Export', featureDiscoveryTitle: 'Run compliance exports with Cusmato Enterprise'},
    {sidebarName: 'Custom Terms of Service', featureDiscoveryTitle: 'Create custom terms of service with Cusmato Enterprise'},
];
