...
describe('SupportSettings', () => {
    ...
    it('MM-T3289_1 - Help (Ask community link setting)', () => {
        ...
        cy.findByTestId('SupportSettings.EnableAskCommunityLinkhelp-text').should('contain', 'When true, "Ask the community" link appears on the Cusmato user interface and Help Menu, which allows users to join the Cusmato Community to ask questions and help others troubleshoot issues. When false, the link is hidden from users.');
