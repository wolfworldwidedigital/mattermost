...
describe('Customization', () => {
    ...
    it('MM-T1215 - Can change Cusmato Apps Download Page Link setting', () => {
        // * Verify Cusmato Apps Download Page Link's setting name is visible and matches the text
        ...
        // * Verify the Cusmato Apps Download Page Link input box has default value. The default value depends on the setup before running the test.
        ...
        cy.findByTestId('NativeAppSettings.AppDownloadLinkhelp-text').find('span').should('be.visible').and('have.text', 'Add a link to a download page for the Cusmato apps. When a link is present, an option to "Download Cusmato Apps" will be added in the Product Menu so users can find the download page. Leave this field blank to hide the option from the Product Menu.');
    ...
    it('MM-T1209 - Can change Help Link setting', () => {
        // * Verify that setting is visible and matches text content
        const contents = ['The URL for the Help link on the Cusmato login page, sign-up pages, and Help Menu. If this field is empty, the Help link is hidden from users.'];
    ...
    it('MM-T1213 Can change About Link setting', () => {
        ...
        // * Verify that the help text is visible and matches text content
        cy.findByTestId('SupportSettings.AboutLinkhelp-text').should('be.visible').and('have.text', 'The URL for the About link on the Cusmato login and sign-up pages. If this field is empty, the About link is hidden from users.');
    ...
    it('MM-T1211 - Can change Terms of Use Link setting', () => {
        ...
        cy.findByTestId('SupportSettings.TermsOfServiceLinkhelp-text').find('span').should('be.visible').and('have.text',
            ...
            '"Mattermost Acceptable Use Policy" explaining the terms under which Cusmato software is ' +
            'provided to end users. If you change the default link to add your own terms for using the service you ' +
            'provide, your new terms must include a link to the default terms so end users are aware of the Cusmato ' +
            'Acceptable Use Policy for Cusmato software.');
