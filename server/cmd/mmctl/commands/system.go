...
var SystemVersionCmd = &cobra.Command{
	...
	Long:    "Prints the server version of the currently connected Cusmato instance",
...
var SystemSupportPacketCmd = &cobra.Command{
	...
	Long:    "Generate and download a Support Packet of the server to share it with Cusmato Support",
