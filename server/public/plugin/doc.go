...
// The plugin package is used by Cusmato server plugins written in go. It also enables the
// Cusmato server to manage and interact with the running plugin environment.
//
