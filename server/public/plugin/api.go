...
type API interface {
	...
	// GetLicense returns the current license used by the Cusmato server. Returns nil if
	...
	// LogDebug writes a log message to the Cusmato server log file.
	...
	// LogInfo writes a log message to the Cusmato server log file.
	// Appropriate context such as the plugin name will already be added as fields so plugins
	// do not need to add that info.
	//
	// @tag Logging
	...
	// LogError writes a log message to the Cusmato server log file.
	// Appropriate context such as the plugin name will already be added as fields so plugins
	// do not need to add that info.
	//
	// @tag Logging
	...
	// LogWarn writes a log message to the Cusmato server log file.
	// Appropriate context such as the plugin name will already be added as fields so plugins
	// do not need to add that info.
	//
	// @tag Logging
