                            ...
                            <div className='col-md-5 col-sm-8 checkbox'>
                                ...
                                <div className='form__help'>
                                    <FormattedMessage
                                        ...
                                        defaultMessage='Bot will have access to post to all Cusmato channels including direct messages.'
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className='col-md-5 col-sm-8 checkbox'>
                                ...
                                <div className='form__help'>
                                    <FormattedMessage
                                        ...
                                        defaultMessage='Bot will have access to post to all Cusmato public channels.'
                                    />
                                </div>
                            </div>
                        </div>
