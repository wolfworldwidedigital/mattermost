                    ...
                    <div className={'banner info'}>
                        <div className='banner__content'>
                            <FormattedMessage
                                ...
                                defaultMessage={'Feature flag values displayed here show the status of features enabled on this server. The values here are used only for troubleshooting by the Cusmato support team.'}
                            />
                        </div>
                    </div>
