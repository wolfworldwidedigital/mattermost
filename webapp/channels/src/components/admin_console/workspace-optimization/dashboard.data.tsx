...
const getAccessData = async (
    ...
    description: formatMessage({
        ...
        defaultMessage: 'Web server configuration may be affecting access to your Cusmato workspace.',
    }),
    hide: options.isCloud,
    descriptionOk: formatMessage({
...
const getEaseOfManagementData = async (
    ...
    description: formatMessage({
        ...
        defaultMessage: 'Make it easier to manage your Cusmato workspace.',
    }),
    descriptionOk: formatMessage({
