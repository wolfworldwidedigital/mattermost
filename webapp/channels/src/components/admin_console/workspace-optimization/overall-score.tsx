...
const OverallScore = ({
    ...
    const contentDescription = description || (
        <FormattedMessage
            ...
            defaultMessage='Stay on top of optimizing your Cusmato workspace by reviewing your overall score below based on our recommended indicators of health and growth. Ensure your workspace is running smoothly so your users can get the most out of Mattermost.'
        />
    );
