...
export const messages = defineMessages({
    ...
    skipTLSVerificationDescription: {id: 'admin.elasticsearch.skipTLSVerificationDescription', defaultMessage: 'When true, Cusmato will not require the Elasticsearch certificate to be signed by a trusted Certificate Authority.'},
    ...
    testHelpText: {id: 'admin.elasticsearch.testHelpText', defaultMessage: 'Tests if the Cusmato server can connect to the Elasticsearch server specified. Testing the connection only saves the configuration if the test is successful. A successful test will also re-initialize the client if you have started Elasticsearch after starting Mattermost. But this will not restart the workers. To do that, please toggle "Enable Elasticsearch Indexing".'},
