                ...
                <Modal.Body>
                    <p className='session-help-text'>
                        <FormattedMessage
                            ...
                            defaultMessage="Sessions are created when you log in through a new browser on a device. Sessions let you use Cusmato without having to log in again for a time period specified by the system administrator. To end the session sooner, use the 'Log Out' button."
                        />
                    </p>
                    {content}
                </Modal.Body>
